...
const RenovationParquetFloor = () => {
  const RenovationParquetFloorData = [
    {
      img: septicTank2,
      imgName: "Article",
  ...
  return (
    <div className="h-650 mt-30 box-shadow">
      <div className="container pt-90">
        <div className="row">
          <div className="col-md-7">
            ...
            Rénovation d'un parquet (ponçage, vitrification)
            </h3>
          </div>
      ...
      <DetailsCartParent data={RenovationParquetFloorData} />
...
export default RenovationParquetFloor;