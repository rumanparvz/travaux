...
const InstallationParquet = () => {
  const installationParquetData = [
    {
      img: heater1,
  ...
  return (
    <div className="h-650 box-shadow">
      <div className="container  d-flex align-items-center pt-90 mb-80">
        <h3 className="me-5 compoTitle">Pose d'un parquet</h3>
        <button className="buttonBg">Publiez votre projet gratuitement</button>
      </div>
      <DetailsCartParent data={installationParquetData} />
...
export default InstallationParquet;