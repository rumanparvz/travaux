...
import img1 from "../../../../assets/images/Installation1.jpg";
import img2 from "../../../../assets/images/Installation2.jpg";
import img3 from "../../../../assets/images/Installation3.jpg";
import DetailsCartParent from '../../Common/DetailsCartParent/DetailsCartParent';
const InstallationWhirlpoolBath = () => {
    const installationWhirlpoolBath = [
        {
          img: img1,
          imgName: "Article",
    ...
    return (
      ...
      <DetailsCartParent data={installationWhirlpoolBath} />
...
export default InstallationWhirlpoolBath;