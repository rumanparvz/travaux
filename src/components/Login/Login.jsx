  ...
  return (
    <div className="login">
      ...
      <div className="container  m-auto login-item" >
        <h1 style={{ fontSize: "50px" }} className='mb-5'>Connexion</h1>
        <form action="">
          <p>
          ...
          <label for="checkbox" className="login_pass w-100 d-flex  align-items-center">
            <input   type="password" className="form-control py-2 w-75 w-sm-100 "   name=""   id=""   />
        ...
        <button className="socialButton"> <FcGoogle /> Sign in with Google</button> 
